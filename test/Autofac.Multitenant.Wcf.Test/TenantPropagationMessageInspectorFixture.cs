...
public class TenantPropagationMessageInspectorFixture
{
    ...
    public void AfterReceiveReply_NoOp()
    {
        ...
        var exception = Record.Exception(() => inspector.AfterReceiveReply(ref msg, new object()));
    ...
    public void BeforeSendReply_NoOp()
    {
        ...
        var exception = Record.Exception(() => inspector.BeforeSendReply(ref msg, new object()));
        Assert.Null(exception);
    }
}
