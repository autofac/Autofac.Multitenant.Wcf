...
namespace Autofac.Multitenant.Wcf
{
    ...
    /// implementation that gets the tenant ID from a <see cref="Autofac.Multitenant.Wcf.TenantIdentificationContextExtension"/>
    /// attached to the current <see cref="System.ServiceModel.OperationContext"/>.
    /// </summary>
    /// <remarks>
    /// <para>
    /// Use this <see cref="Autofac.Multitenant.ITenantIdentificationStrategy"/>
    /// if you are using the <see cref="Autofac.Multitenant.Wcf.TenantIdentificationContextExtension"/>
    ...
    /// </para>
    /// </remarks>
    /// <seealso cref="Autofac.Multitenant.Wcf.TenantIdentificationContextExtension"/>
